...
void OLED_ON(void){
    OLED_Clear();
//wifi连接中
    OLED_ShowCHinese(18,2,37);//
    OLED_ShowCHinese(36,2,38);//
    OLED_ShowCHinese(54,2,39);//
...
void yuzhi(void){
    OLED_Clear();
    OLED_ShowCHinese(18,0,28);//阈
    OLED_ShowCHinese(32,0,29);//值
    OLED_ShowCHinese(50,0,30);//设
    OLED_ShowCHinese(68,0,31);//置
    OLED_ShowCHinese(0,2,5);//光
    OLED_ShowCHinese(18,2,7);//强
    OLED_ShowNum(2,7,threshold,3);//光照值整数位
...
void OLED_Fire(void){
    ...
    OLED_ShowCHinese(18,6,32);//阈
    OLED_ShowCHinese(32,6,33);//值
    OLED_ShowCHinese(50,6,34);//设
    OLED_ShowCHinese(68,6,35);//置
    OLED_ShowCHinese(86,6,36);//置
